...
def run_cnn_autoencoder_pipeline(dataset_names, dataset_curves, Y_well, ref_curves, ae_plot_path, threshold_percentiles=None, epochs=60, batch_size=128, save_plot=True, downsample_factor=1, per_well=True):
