...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="cnn_gru_dual / cnn_gru_dual_attn_recon saliency + latent-feature-mapping "
