#!/bin/bash
#SBATCH --job-name=f_lf_g13_orinorm
...
# Same as f_lf_g13_acqstart.sh, but CURVE_TYPES=ori_curve_norm (was
# ori_curve_sg_p4_norm) and ALIGN_ARGS uses pc_ttp instead of acquisition_start
# (i.e. f_lf_g13.sh's own default alignment, just with the ori_curve_norm curve
# type instead of ori_curve_sg_p4_norm).
