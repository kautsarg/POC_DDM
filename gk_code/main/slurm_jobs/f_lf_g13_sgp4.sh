...
# Same as f_lf_g13_acqstart.sh, but CURVE_TYPES=ori_curve_sg_p4 (was
# ori_curve_sg_p4_norm -- SG-P4-smoothed but not normalized) and ALIGN_ARGS
# uses pc_ttp instead of acquisition_start (i.e. f_lf_g13.sh's own default
# alignment, just with the un-normalized curve type).
